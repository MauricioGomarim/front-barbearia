    ...
    >
      ...
      <div className="content">
        <div className="conteudo">
          <h1>Agendamentos</h1>
          <Section>
            <div className="header-servicos !justify-end">
              ...
              <div className="linha-servicos-tabela">
                <div className="flex px-8 header-tabela">
                  ...
                  <div className="w-28 flex items-center">
                    <h1 className="color-green">Aprovado</h1>
                  </div>
                </div>
              </div>
              <div className="linha-servicos-tabela">
                <div className="flex px-8 header-tabela">
                  ...
                  <div className="w-28 flex items-center">
                    <h1 className="color-red">Reprovado</h1>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="conteiner-servicos-mobile">
              <div className="card-servico-mobile">
                <div className="content-servico">
                  <h1>
                    <span>Nome:</span> José Mauricio Gomarim Da Silva
                  </h1>
                  <p>
                    <span>Telefone:</span> (17) 99211-8342
                  </p>
                  <p>
                    <span>Serviços:</span> Cortes para todos os tipos
                  </p>
                  <div className="flex justify-between">
                    <p>
                      <span>Valor:</span> R$ 35,00
                    </p>
                    <p>
                      <span>Data:</span> 15/02/2024
                    </p>
                  </div>
                  <p>
                    <span>Status:</span> <span className="color-green">Aprovado</span>
                  </p>
                </div>
                <div className="dots">
                  <img src={dots} />
              ...
              <div className="card-servico-mobile">
                <div className="content-servico">
                  ...
                  <p>
                    <span>Status:</span> <span className="color-red">Reprovado</span>
                  </p>
                </div>
                <div className="dots">
                  <img src={dots} />
